...
export const TOKEN_LIST_TEXT_CAPS = { name: 80, description: 300, note: 500 } as const;
...
export async function createList(
    ...
    const description = optionalString(a, 'description', TOKEN_LIST_TEXT_CAPS.description) ?? null;
...
export async function updateList(
    ...
    const description = optionalString(a, 'description', TOKEN_LIST_TEXT_CAPS.description);
