...
| GET    | `/v1/assets/:assetId/launches`       | API key                                              | Approved launchpad coins launched against this asset's mints (may be empty)                  | `{ assetId, total, limit, launches[], lastUpdatedAt }`      |
